...
describe("Wasap", function () {
  ...
  describe("Add contacts", function () {
    ...
    it("Should add contact to contact list and emit event", async function () {
      ...
      const contactListUser1 = await wasap.connect(user1).getUserContactList();
      ...
      const contactListUser2 = await wasap.connect(user2).getUserContactList();
  ...
  describe("Send messages", async function () {
    ...
    it("Should send messages", async function () {
      ...
      await wasap
        .connect(user1)
        .sendMessage(await user2.getAddress(), message1to2);

      await wasap
        .connect(user2)
        .sendMessage(await user1.getAddress(), message2to1);
